# Vyhledávač soupisek pro kamaráda (bez GitHubu)

Jednoduchá webová stránka s formulářem: kamarád napíše název týmu a PIN, dostane soupisku hráčů rovnou
na stránce a může si ji stáhnout jako Excel (CSV). Běží na Cloudflare Workers zdarma, bez nutnosti mít
GitHub účet — kamarád jen otevře odkaz v prohlížeči.
...
2. Zadá PIN a název týmu (stačí i jen část názvu, např. "Kobenhavn").
3. Uvidí tabulku hráčů rovnou na stránce.
4. Volitelně klikne na "Stáhnout jako Excel (CSV)" a soubor se mu stáhne do počítače/mobilu.
